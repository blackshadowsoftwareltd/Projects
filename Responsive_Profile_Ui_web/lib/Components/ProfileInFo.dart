...
import 'package:profile_web/ReUsableComponent/ReUsableButton.dart';
import 'package:profile_web/ReUsableComponent/ReUsableText.dart';
...
class ProfileInFo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      LargeBoldTextBlack('Jenna Stones'),
      SizedBox(height: 10),
      Row(
