...
import 'package:news_getx/Reusable_Components/texts.dart';
import 'package:news_getx/Services/PlatformServices.dart';
...
class ProductFeature extends StatelessWidget {
  ...
  Widget featureTexts(BuildContext context) =>
      Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
        ...
        Divider(height: 10, thickness: 2, color: Colors.green[300]),
        normalBlackText(
  ...
  Widget featureImages(BuildContext context) => Padding(
        ...
        child: SizedBox(
            height:
                PlatFormServices.isMobile(context) ? _width / 2 : _width / 4,
  ...
  Widget learnMoreButton(BuildContext context, String text) => Container(
      ...
      child: Text('$text',
          style: TextStyle(
              color: Colors.white,
              fontSize: PlatFormServices.isMobile(context)
                  ? 15
                  : _width / 60)));
}
